...
class LottoesTest {
    ...
    void winLottoesResult() {
        ...
        // when
        final MachedLottoes matchedLottoes = lottoes.checkWinningRate(new Lotto(Arrays.asList(3, 4, 5, 6, 7, 8)));
    ...
    void notWinLottoesResult() {
        ...
        // when
        final MachedLottoes matchedLottoes = lottoes.checkWinningRate(new Lotto(Arrays.asList(30, 31, 32, 33, 34, 45)));
